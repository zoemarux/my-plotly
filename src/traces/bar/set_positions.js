...
function setOffsetAndWidthInGroupMode(gd, pa, sieve) {
    ...
    // trello289: barチャートbarmode:groupの場合のアノテーション表示位置設定
    // （rwplotly内にてchart_div(gd)._fullLayoutに_wp_bar_group_calcTracesを設定）
    gd._fullLayout._wp_bar_group_calcTraces = calcTraces;
