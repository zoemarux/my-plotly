...
Plotly.restyle = function restyle(gd, astr, val, traces) {
    ...
    flags.clearCalc = false; //disable automatically resizing the chart by when this is called
...
Plotly.update = function update(gd, traceUpdate, layoutUpdate, traces) {
    ...
    // if it is true, it automatically tries to resize a chart when it is called
    restyleFlags.clearCalc = false;

    //if it is true, x axis, y axis or both will dissapear
    // also if it is false alone, you will get an error
    restyleFlags.fullReplot = false;
